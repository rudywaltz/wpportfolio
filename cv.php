  ...
  <section id="content" role="main">
    ...
    <table class="op-table">
      ...
      <?php if ( ! empty( $educations ) ) : ?>
        <tr>
          <th width="240px" align="left" class="group"><span><?php pll_e( 'Tanulmányok' ) ?></span></th>
        <th></th>
        </tr>
      ...
      <?php if ( ! empty( $featured_items ) ) : ?>
        <tr>
        <th width="240px" align="left" class="group"><span><?php pll_e( 'Önálló Kiállítások' ) ?></span></th>
        <th></th>
        </tr>
      ...
      <?php if ( ! empty( $featured_items_group ) ) : ?>
        <tr>
        <th width="240px" align="left" class="group"><span><?php pll_e( 'Csoportos Kiállítások' ) ?></span></th>
        <th></th>
        </tr>
      ...
      <?php if ( ! empty( $prize ) ) : ?>
        <tr>
          <th width="240px" align="left" class="group"><span><?php pll_e( 'Díjak' ) ?></span></th>
          <th></th>
        </tr>
      ...
      <?php if ( ! empty( $membership ) ) : ?>
        <tr>
          <th width="240px" align="left" class="group"><span><?php pll_e( 'Tagság' ) ?></span></th>
          <th></th>
        </tr>
